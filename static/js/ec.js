(function( $ ) {
   ...
   //Ammar input fields values updated 
    $.ec.Base.prototype.getInputValues = function() {
        this.a = 0;//+this.aInput.val();
        this.b = 7//+this.bInput.val();
    };
    ...
    $.ec.modk.Base.prototype.getPlotRange = function( points ) {
        ...
        points.push([ 1, 1 ]);
        var x = 115792089237316195423570985008687907852837564279074904382605163141518161494336;
        var y =x;
...
//update this method to calculate exact points in no time 
    ...
    $.ec.modk.Base.prototype.getInputValues = function() {
       ...
       /// this.k = 113;//+this.kInput.val();
        this.gX = 55066263022277343669578718895168534326250603453777594175500187360389116729240;
        this.gY = 32670510020758816978083085130507043184471273380659243275938904335757337482424;
        this.k = 0;//115792089237316195423570985008687907852837564279074904382605163141518161494336;
    ...
    $.ec.modk.PointAddition.prototype.getInputValues = function() {
        ...
        this.p = [this.pxInput, this.pyInput]; //this.fixPointCoordinate( this.pxInput, this.pyInput );
        this.q = [ this.qxInput, this.qyInput ]; //this.fixPointCoordinate( this.qxInput, this.qyInput );
        console.log("LOg values in fix point addition "+this.p+"\n");
    };

    $.ec.modk.PointAddition.prototype.recalculate = function() {
         console.log("Trying to add P and Q");
        this.r = this.addPoints( this.p, this.q );
    ...
    $.ec.modk.PointAddition.prototype.redraw = function() {
        ...
        this.setLabel( this.rLabel, this.r );
       // var g = [50,50];
        this.setLabel(this.gLabel,[this.gX,this.gY]);//Green point addiation 
